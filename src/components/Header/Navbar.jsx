        ...
        <div className="navbar bg-base-100">
            ...
            <div className="navbar-end gap-4">
                <label className="cursor-pointer grid place-items-center">
                    <input onChange={handleToggle} type="checkbox" className="toggle theme-controller bg-base-content hidden lg:flex row-start-1 col-start-1 col-span-2" />
                ...
                <Link to="/loginPage">
                    <button className="bg-yellow-700 text-white px-2 py-1 rounded-md">Login</button>
                </Link>
            </div>
        </div>
    );
