        ...
        <div className="bg-[#030712] text-white">
            ...
            <footer className="footer lg:px-24 px-8 py-5 my-16">
                <nav>
                    ...
                    <a className="link link-hover">Craft Items</a>
                ...
                <nav>
                    <h6 className="footer-title mt-5 mb-5">Social</h6>
            ...
            <div className="mt-5 mb-5 text-center p-8">
                <aside>
                    <p>Copyright © 2024 Ceramiic, All rights reserved. Present by Rometheme</p>
                </aside>
            </div>
        </div>
    );
